...
export function Home() {
	const [stories, setStories] = useState<Story[]>([{
		...
		{
			title: 'Another Story',
			description: 'This is another example story.',
			image: preactLogo, // no image yet
			author: 'Jane Smith',
			date: new Date(),
			category: 'Fiction',
		},]);
			...
			<section>
				<div id="story-holder">
					...
					{stories.sort((a,b) =>a.date.getTime() - b.date.getTime()).map((story) => {
							return story.image && <img key={story.date} src={story.image} alt={story.title} class="story" onClick={handleStoryClick}/>
					})}
				</div>
			</section>
		</div>
